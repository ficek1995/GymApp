...
namespace GymApp.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SettingsController : GymApp.Controllers.SettingsController
    {
        ...
        [NonAction]
        partial void FormOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GymApp.Models.ViewsModels.MessageViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Form(GymApp.Models.ViewsModels.MessageViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Form);
